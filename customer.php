    ...
    <div class="container col-md-7 mt-4">
        ...
        <div class="card">
            <div class="card-header bg-dark text-white d-flex justify-content-between">
                ...
                DATA CUSTOMER <a href="tambah_customer.php" class="btn btn-sm btn-dark float-right"><i class="bi bi-plus-circle-fill"></i></a>
        </div>
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <body>
                    <?php
                        include('koneksi.php');
                        $datas = mysqli_query($koneksi, "SELECT * FROM `customer`;
                        ...
                        while($row = mysqli_fetch_array($datas)){
                            ...
                            echo "<a class='btn btn-sm btn-secondary' href='edit_customer.php?id=".$row['id']."'>Edit</a> ";
                            echo "<a class='btn btn-sm btn-dark' onclick='return confirm('anda yakin ingin hapus?');' href='hapus_customer.php?id=".$row['id']."'>Hapus</a>";
                            echo "</td>";
