        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <body>
                    <?php
                        include('koneksi.php');
                        $datas = mysqli_query($koneksi, "SELECT product.id, product.name, product.image, customer.customer_name, customer.email, merchant.nama_toko, merchant.image_toko FROM product, customer, merchant WHERE product.id=customer.id=merchant.id;
                        ;
